...
"${PYTHON}" -m pip install --quiet tomli-w tomli jinja2 click packaging 2>/dev/null || \
"${PYTHON}" -m pip install --quiet --break-system-packages tomli-w tomli jinja2 click packaging 2>/dev/null || true
